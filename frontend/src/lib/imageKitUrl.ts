...
const buildNorthwindTextLayer = ({ w, h }: ImageKitOptions) => {
  ...
  return `l-text,i-Nortshop,fs-${fs},co-FFFFFF,bg-0F172A90,pa-8_12,lx-N14,ly-14,lap-top_right,l-end`;
};
 ...
 */
export const imageKitOptimizedUrl = (
...
/**
 * Same optimizations as {@link imageKitOptimizedUrl} plus Northshop text overlay (for share/download).
 * Non-ImageKit URLs are returned unchanged.
 */
export const imageKitWatermarkedUrl = (
  url: string | null | undefined,
  opts: ImageKitOptions = {},
) => {
